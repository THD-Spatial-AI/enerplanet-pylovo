...
# Ensure shared source-table columns exist before single-PLZ generation.
# In multiprocessing mode this is done once in runme/create/generate_grid.py.
gg.dbc.ensure_shared_table_columns()
